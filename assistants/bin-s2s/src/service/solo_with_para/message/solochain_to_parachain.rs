...
impl<
        ...
        CPI: S2SSoloBridgeSoloChainInfo,
        SI: SubqueryInfo,
    > BridgeService for SolochainToParachainMessageRelayService<CSI, CRI, CPI, SI>
{
}
...
impl<
        ...
        CPI: S2SSoloBridgeSoloChainInfo,
        SI: SubqueryInfo,
    > Service for SolochainToParachainMessageRelayService<CSI, CRI, CPI, SI>
{
    type Bus = BridgeBus;
...
impl<
        ...
        CPI: S2SSoloBridgeSoloChainInfo,
        SI: SubqueryInfo,
    > SolochainToParachainMessageRelayService<CSI, CRI, CPI, SI>
{
