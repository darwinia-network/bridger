...
#[derive(Debug)]
pub struct PangolinParachainToPangolinMessageRelayService {
    _greet_delivery: Lifeline,
    _greet_receiving: Lifeline,
}

impl BridgeService for PangolinParachainToPangolinMessageRelayService {}

impl Service for PangolinParachainToPangolinMessageRelayService {
    type Bus = BridgeBus;
...
async fn message_input() -> color_eyre::Result<MessageReceivingInput<PangolinParachainClient, PangolinClient>>
{
