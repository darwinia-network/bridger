...
pub struct PangolinRuntime;
impl Runtime for PangolinRuntime {
...
impl Balances for PangolinRuntime {
	type Balance = u128;
}

impl System for PangolinRuntime {
	type Index = u32;
...
impl TechnicalCommittee for PangolinRuntime {}
impl Sudo for PangolinRuntime {}
impl EthereumRelay for PangolinRuntime {
...
impl EthereumRelayerGame for PangolinRuntime {
...
impl EthereumIssuing for PangolinRuntime {
	type EthereumTransactionIndex = u64;
}

impl Proxy for PangolinRuntime {
	type ProxyType = ProxyType;
}

impl EthereumRelayAuthorities for PangolinRuntime {
