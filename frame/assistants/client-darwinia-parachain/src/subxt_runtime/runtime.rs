...
pub mod api {
    ...
    pub enum Event {
        ...
        Sudo(sudo::Event),
        #[codec(index = 21)]
        BridgeDarwiniaMessages(bridge_darwinia_messages::Event),
        #[codec(index = 22)]
        BridgeDarwiniaDispatch(bridge_darwinia_dispatch::Event),
        #[codec(index = 23)]
        DarwiniaFeeMarket(darwinia_fee_market::Event),
        #[codec(index = 24)]
        FromDarwiniaIssuing(from_darwinia_issuing::Event),
        #[codec(index = 26)]
        MessageRouter(message_router::Event),
    }
    pub mod system {
            ...
            impl ::subxt::StorageEntry for Events {
                ...
                type Value = ::std::vec::Vec<
                    runtime_types::frame_system::EventRecord<
                        runtime_types::darwinia_parachain_runtime::Event,
                        ::subxt::sp_core::H256,
                    >,
                >;
                fn key(&self) -> ::subxt::StorageEntryKey {
        ...
        pub mod constants {
            ...
            impl ConstantsApi {
                ...
                > {
                    Ok(::subxt::codec::Decode::decode(
                        &mut &[
                            72u8, 68u8, 97u8, 114u8, 119u8, 105u8, 110u8, 105u8, 97u8, 32u8, 80u8,
                            97u8, 114u8, 97u8, 99u8, 104u8, 97u8, 105u8, 110u8, 72u8, 68u8, 97u8,
                            114u8, 119u8, 105u8, 110u8, 105u8, 97u8, 32u8, 80u8, 97u8, 114u8, 97u8,
                            99u8, 104u8, 97u8, 105u8, 110u8, 1u8, 0u8, 0u8, 0u8, 220u8, 20u8, 0u8,
                            0u8, 1u8, 0u8, 0u8, 0u8, 40u8, 223u8, 106u8, 203u8, 104u8, 153u8, 7u8,
    ...
    pub mod parachain_system {
        ...
        pub mod events {
            ...
            pub struct DownwardMessagesProcessed {
                ...
                pub dmq_head: ::subxt::sp_core::H256,
            }
        ...
        pub mod storage {
            ...
            pub struct LastRelayChainBlockNumber;
            impl ::subxt::StorageEntry for LastRelayChainBlockNumber {
                const PALLET: &'static str = "ParachainSystem";
                const STORAGE: &'static str = "LastRelayChainBlockNumber";
                type Value = ::core::primitive::u32;
                fn key(&self) -> ::subxt::StorageEntryKey {
                    ::subxt::StorageEntryKey::Plain
                }
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                pub async fn last_relay_chain_block_number(
                    &self,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<::core::primitive::u32, ::subxt::BasicError>
                {
                    let entry = LastRelayChainBlockNumber;
                    self.client.storage().fetch_or_default(&entry, hash).await
                }
                ...
                pub async fn relay_state_proof(
                    &self,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<
    ...
    pub mod session {
        ...
        pub mod calls {
            ...
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct set_keys {
                pub keys: runtime_types::darwinia_parachain_runtime::pallets::session::SessionKeys,
                ...
                A: ::subxt::AccountData,
            {
                ...
                pub fn set_keys(
                    &self,
                    keys: runtime_types::darwinia_parachain_runtime::pallets::session::SessionKeys,
        ...
        pub mod storage {
            ...
            impl ::subxt::StorageEntry for QueuedKeys {
                ...
                type Value = ::std::vec::Vec<(
                    ::subxt::sp_core::crypto::AccountId32,
                    runtime_types::darwinia_parachain_runtime::pallets::session::SessionKeys,
                )>;
                fn key(&self) -> ::subxt::StorageEntryKey {
                    ::subxt::StorageEntryKey::Plain
                }
    ...
    pub mod xcmp_queue {
        ...
        pub mod calls {
            ...
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct suspend_xcm_execution;
            impl ::subxt::Call for suspend_xcm_execution {
                const PALLET: &'static str = "XcmpQueue";
                const FUNCTION: &'static str = "suspend_xcm_execution";
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct resume_xcm_execution;
            impl ::subxt::Call for resume_xcm_execution {
                const PALLET: &'static str = "XcmpQueue";
            ...
            pub struct update_suspend_threshold {
                pub new: ::core::primitive::u32,
            }
            impl ::subxt::Call for update_suspend_threshold {
                const PALLET: &'static str = "XcmpQueue";
            ...
            pub struct update_drop_threshold {
                pub new: ::core::primitive::u32,
            }
            impl ::subxt::Call for update_drop_threshold {
                const PALLET: &'static str = "XcmpQueue";
            ...
            pub struct update_resume_threshold {
                pub new: ::core::primitive::u32,
            }
            impl ::subxt::Call for update_resume_threshold {
                const PALLET: &'static str = "XcmpQueue";
            ...
            pub struct update_threshold_weight {
                pub new: ::core::primitive::u64,
            }
            impl ::subxt::Call for update_threshold_weight {
                const PALLET: &'static str = "XcmpQueue";
            ...
            pub struct update_weight_restrict_decay {
                pub new: ::core::primitive::u64,
            }
            impl ::subxt::Call for update_weight_restrict_decay {
                const PALLET: &'static str = "XcmpQueue";
            ...
            pub struct update_xcmp_max_individual_weight {
                pub new: ::core::primitive::u64,
            }
            impl ::subxt::Call for update_xcmp_max_individual_weight {
                const PALLET: &'static str = "XcmpQueue";
                ...
                A: ::subxt::AccountData,
            {
                ...
                pub fn suspend_xcm_execution(
                    &self,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, A, suspend_xcm_execution, DispatchError>
                {
                    let call = suspend_xcm_execution {};
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
                pub fn resume_xcm_execution(
                    &self,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, A, resume_xcm_execution, DispatchError>
                {
                    let call = resume_xcm_execution {};
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
                pub fn update_suspend_threshold(
                    ...
                    DispatchError,
                > {
                    let call = update_suspend_threshold { new };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
                pub fn update_drop_threshold(
                    &self,
                    new: ::core::primitive::u32,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, A, update_drop_threshold, DispatchError>
                {
                    let call = update_drop_threshold { new };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
                pub fn update_resume_threshold(
                    ...
                    DispatchError,
                > {
                    let call = update_resume_threshold { new };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
                pub fn update_threshold_weight(
                    ...
                    DispatchError,
                > {
                    let call = update_threshold_weight { new };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
                pub fn update_weight_restrict_decay(
                    ...
                    DispatchError,
                > {
                    let call = update_weight_restrict_decay { new };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
                pub fn update_xcmp_max_individual_weight(
                    ...
                    DispatchError,
                > {
                    let call = update_xcmp_max_individual_weight { new };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
            }
        }
        ...
        pub mod events {
            ...
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct Success {
                pub message_hash: ::core::option::Option<::subxt::sp_core::H256>,
    ...
    pub mod utility {
        ...
        pub mod calls {
            ...
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct batch {
                pub calls: ::std::vec::Vec<runtime_types::darwinia_parachain_runtime::Call>,
            }
            ...
            pub struct as_derivative {
                ...
                pub call: ::std::boxed::Box<runtime_types::darwinia_parachain_runtime::Call>,
            }
            ...
            pub struct dispatch_as {
                pub as_origin:
                    ::std::boxed::Box<runtime_types::darwinia_parachain_runtime::OriginCaller>,
                pub call: ::std::boxed::Box<runtime_types::darwinia_parachain_runtime::Call>,
            }
                ...
                A: ::subxt::AccountData,
            {
                ...
                pub fn batch(
                    &self,
                    calls: ::std::vec::Vec<runtime_types::darwinia_parachain_runtime::Call>,
                ...
                pub fn as_derivative(
                    ...
                    call: runtime_types::darwinia_parachain_runtime::Call,
                ...
                pub fn dispatch_as(
                    &self,
                    as_origin: runtime_types::darwinia_parachain_runtime::OriginCaller,
                    call: runtime_types::darwinia_parachain_runtime::Call,
    ...
    pub mod multisig {
        ...
        pub mod calls {
            ...
            pub struct as_multi {
                ...
                >,
                pub call:
                    ::subxt::WrapperKeepOpaque<runtime_types::darwinia_parachain_runtime::Call>,
                ...
                A: ::subxt::AccountData,
            {
                ...
                pub fn as_multi(
                    ...
                    call: ::subxt::WrapperKeepOpaque<
                        runtime_types::darwinia_parachain_runtime::Call,
                    >,
        ...
        pub mod constants {
            ...
            impl ConstantsApi {
                ...
                ) -> ::core::result::Result<::core::primitive::u128, ::subxt::BasicError>
                {
                    Ok(::subxt::codec::Decode::decode(
                        &mut &[
                            0u8, 0u8, 214u8, 189u8, 150u8, 137u8, 173u8, 21u8, 1u8, 0u8, 0u8, 0u8,
                            0u8, 0u8, 0u8, 0u8,
                        ][..],
                    )?)
                }
                ...
                ) -> ::core::result::Result<::core::primitive::u128, ::subxt::BasicError>
                {
                    Ok(::subxt::codec::Decode::decode(
                        &mut &[
                            0u8, 0u8, 72u8, 15u8, 98u8, 94u8, 11u8, 0u8, 0u8, 0u8, 0u8, 0u8, 0u8,
                            0u8, 0u8, 0u8,
                        ][..],
                    )?)
                }
    ...
    pub mod proxy {
        ...
        pub mod calls {
            ...
            pub struct proxy {
                ...
                pub force_proxy_type: ::core::option::Option<
                    runtime_types::darwinia_parachain_runtime::pallets::proxy::ProxyType,
                >,
                pub call: ::std::boxed::Box<runtime_types::darwinia_parachain_runtime::Call>,
            }
                ...
                A: ::subxt::AccountData,
            {
                ...
                pub fn add_proxy(
                    ...
                    proxy_type : runtime_types :: darwinia_parachain_runtime :: pallets :: proxy :: ProxyType,
        ...
        pub mod storage {
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                pub fn new(client: &'a ::subxt::Client<T>) -> Self {
                    Self { client }
                }                pub async fn proxies (& self , _0 : :: subxt :: sp_core :: crypto :: AccountId32 , hash : :: core :: option :: Option < T :: Hash > ,) -> :: core :: result :: Result < (runtime_types :: sp_runtime :: bounded :: bounded_vec :: BoundedVec < runtime_types :: pallet_proxy :: ProxyDefinition < :: subxt :: sp_core :: crypto :: AccountId32 , runtime_types :: darwinia_parachain_runtime :: pallets :: proxy :: ProxyType , :: core :: primitive :: u32 > > , :: core :: primitive :: u128 ,) , :: subxt :: BasicError >{
        ...
        pub mod constants {
            ...
            impl ConstantsApi {
                ...
                ) -> ::core::result::Result<::core::primitive::u128, ::subxt::BasicError>
                {
                    Ok(::subxt::codec::Decode::decode(
                        &mut &[
                            0u8, 0u8, 234u8, 166u8, 3u8, 124u8, 156u8, 21u8, 1u8, 0u8, 0u8, 0u8,
                            0u8, 0u8, 0u8, 0u8,
                        ][..],
                    )?)
                }
                ...
                ) -> ::core::result::Result<::core::primitive::u128, ::subxt::BasicError>
                {
                    Ok(::subxt::codec::Decode::decode(
                        &mut &[
                            0u8, 64u8, 194u8, 31u8, 85u8, 185u8, 11u8, 0u8, 0u8, 0u8, 0u8, 0u8,
                            0u8, 0u8, 0u8, 0u8,
                        ][..],
                    )?)
                }
                ...
                ) -> ::core::result::Result<::core::primitive::u128, ::subxt::BasicError>
                {
                    Ok(::subxt::codec::Decode::decode(
                        &mut &[
                            0u8, 0u8, 188u8, 42u8, 156u8, 83u8, 159u8, 21u8, 1u8, 0u8, 0u8, 0u8,
                            0u8, 0u8, 0u8, 0u8,
                        ][..],
                    )?)
                }
                ...
                ) -> ::core::result::Result<::core::primitive::u128, ::subxt::BasicError>
                {
                    Ok(::subxt::codec::Decode::decode(
                        &mut &[
                            0u8, 128u8, 132u8, 63u8, 170u8, 114u8, 23u8, 0u8, 0u8, 0u8, 0u8, 0u8,
                            0u8, 0u8, 0u8, 0u8,
                        ][..],
                    )?)
                }
    ...
    pub mod bridge_darwinia_grandpa {
        use super::runtime_types;
        pub mod calls {
            use super::runtime_types;
            type DispatchError = runtime_types::sp_runtime::DispatchError;
            ...
            impl ::subxt::Call for submit_finality_proof {
                const PALLET: &'static str = "BridgeDarwiniaGrandpa";
    ...
    pub mod bridge_darwinia_messages {
        use super::runtime_types;
        pub mod calls {
            use super::runtime_types;
            type DispatchError = runtime_types::sp_runtime::DispatchError;
            ...
            impl ::subxt::Call for set_owner {
                const PALLET: &'static str = "BridgeDarwiniaMessages";
                const FUNCTION: &'static str = "set_owner";
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            ...
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct update_pallet_parameter { pub parameter : runtime_types :: darwinia_parachain_runtime :: bridges_message :: darwinia :: DarwiniaParachainToDarwiniaParameter , }
                ...
                A: ::subxt::AccountData,
            {
                ...
                pub fn update_pallet_parameter(
                    &self,
                    parameter : runtime_types :: darwinia_parachain_runtime :: bridges_message :: darwinia :: DarwiniaParachainToDarwiniaParameter,
                ) -> ::subxt::SubmittableExtrinsic<
                    'a,
                    T,
                    X,
        ...
        pub mod events {
            use super::runtime_types;
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct ParameterUpdated (pub runtime_types :: darwinia_parachain_runtime :: bridges_message :: darwinia :: DarwiniaParachainToDarwiniaParameter ,) ;
        ...
        pub mod constants {
            ...
            impl ConstantsApi {
                ...
                {
                    Ok(::subxt::codec::Decode::decode(
                        &mut &[100u8, 97u8, 114u8, 119u8][..],
                    )?)
                }
            }
        }
    }
    pub mod bridge_darwinia_dispatch {
        use super::runtime_types;
        ...
        pub mod events {
            ...
            impl ::subxt::Event for MessageRejected {
                const PALLET: &'static str = "BridgeDarwiniaDispatch";
    ...
    pub mod darwinia_fee_market {
        ...
        pub mod calls {
            ...
            impl ::subxt::Call for enroll_and_lock_collateral {
                const PALLET: &'static str = "DarwiniaFeeMarket";
        ...
        pub mod constants {
            ...
            impl ConstantsApi {
                ...
                {
                    Ok(::subxt::codec::Decode::decode(
                        &mut &[100u8, 97u8, 47u8, 102u8, 101u8, 101u8, 100u8, 97u8][..],
                    )?)
                }
                ...
                pub fn duty_relayers_reward_ratio(
                    &self,
                ) -> ::core::result::Result<
    ...
    pub mod from_darwinia_issuing {
        use super::runtime_types;
        pub mod calls {
            use super::runtime_types;
            type DispatchError = runtime_types::sp_runtime::DispatchError;
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct issue_from_remote {
                pub value: ::core::primitive::u128,
                pub recipient: ::subxt::sp_core::crypto::AccountId32,
                pub burn_pruned_messages: ::std::vec::Vec<::core::primitive::u64>,
                pub min_retain_received_nonce: ::core::primitive::u64,
            }
            impl ::subxt::Call for issue_from_remote {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                const FUNCTION: &'static str = "issue_from_remote";
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct burn_and_remote_unlock {
                pub spec_version: ::core::primitive::u32,
                pub weight: ::core::primitive::u64,
                pub gas_limit: ::core::primitive::u128,
                #[codec(compact)]
                pub value: ::core::primitive::u128,
                #[codec(compact)]
            ...
            impl ::subxt::Call for burn_and_remote_unlock {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                const FUNCTION: &'static str = "burn_and_remote_unlock";
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct handle_issuing_failure_from_remote {
                pub failure_nonce: ::core::primitive::u64,
                pub burn_pruned_messages: ::std::vec::Vec<::core::primitive::u64>,
                pub min_retain_received_nonce: ::core::primitive::u64,
            }
            impl ::subxt::Call for handle_issuing_failure_from_remote {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                const FUNCTION: &'static str = "handle_issuing_failure_from_remote";
            }
            #[derive(
                :: subxt :: codec :: Encode,
                :: subxt :: codec :: Decode,
            ...
            pub struct handle_issuing_failure_local {
                pub failure_nonce: ::core::primitive::u64,
            }
            impl ::subxt::Call for handle_issuing_failure_local {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                const FUNCTION: &'static str = "handle_issuing_failure_local";
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct remote_unlock_failure {
                pub spec_version: ::core::primitive::u32,
                pub weight: ::core::primitive::u64,
                pub gas_limit: ::core::primitive::u128,
                pub failure_nonce: ::core::primitive::u64,
            ...
            impl ::subxt::Call for remote_unlock_failure {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                const FUNCTION: &'static str = "remote_unlock_failure";
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct set_remote_backing_account {
                pub account: ::subxt::sp_core::crypto::AccountId32,
            }
            impl ::subxt::Call for set_remote_backing_account {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                ...
                A: ::subxt::AccountData,
            {
                ...
                pub fn issue_from_remote(
                    ...
                    burn_pruned_messages: ::std::vec::Vec<::core::primitive::u64>,
                    min_retain_received_nonce: ::core::primitive::u64,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, A, issue_from_remote, DispatchError>
                {
                    let call = issue_from_remote {
                        value,
                        recipient,
                        burn_pruned_messages,
                        min_retain_received_nonce,
                    };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
                pub fn burn_and_remote_unlock(
                    ...
                    weight: ::core::primitive::u64,
                    gas_limit: ::core::primitive::u128,
                    value: ::core::primitive::u128,
                    fee: ::core::primitive::u128,
                    recipient: runtime_types::primitive_types::H160,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, A, burn_and_remote_unlock, DispatchError>
                {
                    let call = burn_and_remote_unlock {
                        spec_version,
                        weight,
                        gas_limit,
                        value,
                ...
                pub fn handle_issuing_failure_from_remote(
                    &self,
                    failure_nonce: ::core::primitive::u64,
                    burn_pruned_messages: ::std::vec::Vec<::core::primitive::u64>,
                    min_retain_received_nonce: ::core::primitive::u64,
                ) -> ::subxt::SubmittableExtrinsic<
                    'a,
                    ...
                    DispatchError,
                > {
                    let call = handle_issuing_failure_from_remote {
                        failure_nonce,
                        burn_pruned_messages,
                        min_retain_received_nonce,
                    };
                ...
                pub fn handle_issuing_failure_local(
                    ...
                    DispatchError,
                > {
                    let call = handle_issuing_failure_local { failure_nonce };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
                pub fn remote_unlock_failure(
                    ...
                    failure_nonce: ::core::primitive::u64,
                    fee: ::core::primitive::u128,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, A, remote_unlock_failure, DispatchError>
                {
                    let call = remote_unlock_failure {
                        spec_version,
                        weight,
                        gas_limit,
                        failure_nonce,
                ...
                pub fn set_remote_backing_account(
                    ...
                    DispatchError,
                > {
                    let call = set_remote_backing_account { account };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
        ...
        pub type Event = runtime_types::dp_common_runtime::helixbridge::pallet::Event;
        pub mod events {
            use super::runtime_types;
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct TokenBurnAndRemoteUnlocked(
                pub [::core::primitive::u8; 4usize],
                pub ::core::primitive::u64,
                pub ::subxt::sp_core::crypto::AccountId32,
            ...
            impl ::subxt::Event for TokenBurnAndRemoteUnlocked {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                const EVENT: &'static str = "TokenBurnAndRemoteUnlocked";
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            ...
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct TokenIssuedForFailure(
                pub [::core::primitive::u8; 4usize],
                pub ::core::primitive::u64,
                pub ::subxt::sp_core::crypto::AccountId32,
                pub ::core::primitive::u128,
            );
            impl ::subxt::Event for TokenIssuedForFailure {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                const EVENT: &'static str = "TokenIssuedForFailure";
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct RemoteUnlockForFailure(
                pub ::core::primitive::u64,
                pub ::core::primitive::u64,
            );
            impl ::subxt::Event for RemoteUnlockForFailure {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                const EVENT: &'static str = "RemoteUnlockForFailure";
            }
        }
        pub mod storage {
            use super::runtime_types;
            ...
            pub struct ReceivedNonces;
            impl ::subxt::StorageEntry for ReceivedNonces {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                const STORAGE: &'static str = "ReceivedNonces";
                type Value = runtime_types::sp_runtime::bounded::bounded_vec::BoundedVec<
                    ::core::primitive::u64,
                >;
                fn key(&self) -> ::subxt::StorageEntryKey {
            ...
            pub struct MinReservedBurnNonce;
            impl ::subxt::StorageEntry for MinReservedBurnNonce {
                const PALLET: &'static str = "FromDarwiniaIssuing";
                const STORAGE: &'static str = "MinReservedBurnNonce";
                type Value = ::core::primitive::u64;
                fn key(&self) -> ::subxt::StorageEntryKey {
                    ::subxt::StorageEntryKey::Plain
                }
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                pub async fn received_nonces(
                    ...
                    ::subxt::BasicError,
                > {
                    let entry = ReceivedNonces;
                    self.client.storage().fetch_or_default(&entry, hash).await
                }
                pub async fn min_reserved_burn_nonce(
                    &self,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<::core::primitive::u64, ::subxt::BasicError>
                {
                    let entry = MinReservedBurnNonce;
                    self.client.storage().fetch_or_default(&entry, hash).await
                }
        ...
        pub mod constants {
            ...
            impl ConstantsApi {
                ...
                > {
                    Ok(::subxt::codec::Decode::decode(
                        &mut &[100u8, 97u8, 47u8, 112u8, 97u8, 97u8, 105u8, 115u8][..],
                    )?)
                }
                pub fn max_reserves(
                    &self,
    ...
    pub mod message_router {
        ...
        pub mod calls {
            ...
            type DispatchError = runtime_types::sp_runtime::DispatchError;
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct set_target_xcm_exec_config {
                pub target_location: runtime_types::xcm::v1::multilocation::MultiLocation,
                pub local_asset_units_per_second: ::core::primitive::u128,
            }
            impl ::subxt::Call for set_target_xcm_exec_config {
                const PALLET: &'static str = "MessageRouter";
                const FUNCTION: &'static str = "set_target_xcm_exec_config";
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct forward {
                pub target: runtime_types::dp_common_runtime::message_router::Target,
                pub message: ::std::boxed::Box<runtime_types::xcm::VersionedXcm>,
            }
            impl ::subxt::Call for forward {
                const PALLET: &'static str = "MessageRouter";
                const FUNCTION: &'static str = "forward";
            }
            pub struct TransactionApi<'a, T: ::subxt::Config, X, A> {
                client: &'a ::subxt::Client<T>,
                marker: ::core::marker::PhantomData<(X, A)>,
                ...
                A: ::subxt::AccountData,
            {
                ...
                pub fn set_target_xcm_exec_config(
                    &self,
                    target_location: runtime_types::xcm::v1::multilocation::MultiLocation,
                    local_asset_units_per_second: ::core::primitive::u128,
                ) -> ::subxt::SubmittableExtrinsic<
                    'a,
                    T,
                    X,
                    ...
                    DispatchError,
                > {
                    let call = set_target_xcm_exec_config {
                        target_location,
                ...
                pub fn forward(
                    &self,
                    target: runtime_types::dp_common_runtime::message_router::Target,
                    message: runtime_types::xcm::VersionedXcm,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, A, forward, DispatchError>
                {
                    let call = forward {
                        target,
                        message: ::std::boxed::Box::new(message),
        ...
        pub type Event = runtime_types::dp_common_runtime::message_router::pallet::Event;
        pub mod events {
            use super::runtime_types;
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct TargetXcmExecConfigChanged {
                pub target_location: runtime_types::xcm::v1::multilocation::MultiLocation,
                pub local_asset_units_per_second: ::core::primitive::u128,
            }
            impl ::subxt::Event for TargetXcmExecConfigChanged {
                const PALLET: &'static str = "MessageRouter";
                const EVENT: &'static str = "TargetXcmExecConfigChanged";
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub struct ForwardTo(
                pub runtime_types::xcm::v1::multilocation::MultiLocation,
                pub runtime_types::dp_common_runtime::message_router::Target,
                pub runtime_types::xcm::v2::Xcm,
                pub ::core::primitive::u64,
                pub ::core::primitive::u128,
            );
            impl ::subxt::Event for ForwardTo {
                const PALLET: &'static str = "MessageRouter";
                const EVENT: &'static str = "ForwardTo";
            }
        }
        pub mod storage {
            use super::runtime_types;
            pub struct TargetXcmExecConfig(
                pub runtime_types::xcm::v1::multilocation::MultiLocation,
            );
            impl ::subxt::StorageEntry for TargetXcmExecConfig {
                const PALLET: &'static str = "MessageRouter";
                const STORAGE: &'static str = "TargetXcmExecConfig";
                type Value = ::core::primitive::u128;
                fn key(&self) -> ::subxt::StorageEntryKey {
                    ::subxt::StorageEntryKey::Map(vec![::subxt::StorageMapKey::new(
                        &self.0,
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                pub async fn target_xcm_exec_config(
                    &self,
                    _0: runtime_types::xcm::v1::multilocation::MultiLocation,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<
                    ::core::option::Option<::core::primitive::u128>,
                    ::subxt::BasicError,
                > {
                    let entry = TargetXcmExecConfig(_0);
                    self.client.storage().fetch(&entry, hash).await
                }
                pub async fn target_xcm_exec_config_iter(
                    &self,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<
                    ::subxt::KeyIter<'a, T, TargetXcmExecConfig>,
                    ::subxt::BasicError,
                > {
                    self.client.storage().iter(hash).await
                }
    ...
    pub mod runtime_types {
        ...
        pub mod cumulus_pallet_parachain_system {
            ...
            pub mod pallet {
                ...
                pub enum Event {
                    ...
                    #[codec(index = 3)]
                    UpgradeAuthorized { code_hash: ::subxt::sp_core::H256 },
                    #[codec(index = 4)]
                    DownwardMessagesReceived { count: ::core::primitive::u32 },
                    #[codec(index = 5)]
                    DownwardMessagesProcessed {
                        weight_used: ::core::primitive::u64,
                        dmq_head: ::subxt::sp_core::H256,
                    },
                }
            }
        ...
        pub mod cumulus_pallet_xcmp_queue {
            ...
            pub mod pallet {
                ...
                pub enum Event {
                    #[codec(index = 0)]
                    Success {
                        message_hash: ::core::option::Option<::subxt::sp_core::H256>,
                        weight: ::core::primitive::u64,
                    },
                    #[codec(index = 1)]
                    Fail {
        ...
        pub mod darwinia_parachain_runtime {
            use super::runtime_types;
            pub mod bridges_message {
                ...
                pub mod darwinia {
                    ...
                    pub enum DarwiniaParachainToDarwiniaParameter {
                        #[codec(index = 0)]
                        DarwiniaToDarwiniaParachainConversionRate(
                            runtime_types::sp_arithmetic::fixed_point::FixedU128,
                        ),
                    }
                }
            ...
            pub enum Call {
                ...
                #[codec(index = 20)]
                BridgeDarwiniaGrandpa(runtime_types::pallet_bridge_grandpa::pallet::Call),
                #[codec(index = 21)]
                BridgeDarwiniaMessages(runtime_types::pallet_bridge_messages::pallet::Call),
                #[codec(index = 23)]
                DarwiniaFeeMarket(runtime_types::pallet_fee_market::pallet::Call),
                #[codec(index = 24)]
                FromDarwiniaIssuing(runtime_types::dp_common_runtime::helixbridge::pallet::Call),
                #[codec(index = 26)]
                MessageRouter(runtime_types::dp_common_runtime::message_router::pallet::Call),
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            pub enum Event {
                #[codec(index = 0)]
                ...
                #[codec(index = 21)]
                BridgeDarwiniaMessages(runtime_types::pallet_bridge_messages::pallet::Event),
                #[codec(index = 22)]
                BridgeDarwiniaDispatch(runtime_types::pallet_bridge_dispatch::pallet::Event),
                #[codec(index = 23)]
                DarwiniaFeeMarket(runtime_types::pallet_fee_market::pallet::Event),
                #[codec(index = 24)]
                FromDarwiniaIssuing(runtime_types::dp_common_runtime::helixbridge::pallet::Event),
                #[codec(index = 26)]
                MessageRouter(runtime_types::dp_common_runtime::message_router::pallet::Event),
            }
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone)]
            ...
            pub mod helixbridge {
                ...
                pub mod pallet {
                    ...
                    pub enum Event {
                        ...
                        #[codec(index = 4)]
                        RemoteUnlockForFailure(::core::primitive::u64, ::core::primitive::u64),
                    }
                }
            }
            pub mod message_router {
                ...
                pub mod pallet {
                    ...
                    pub enum Event {
                        ...
                        ForwardTo(
                            ...
                            runtime_types::dp_common_runtime::message_router::Target,
            ...
            pub mod pallet {
                ...
                pub enum Call {
                    ...
                    as_multi_threshold_1 {
                        other_signatories: ::std::vec::Vec<::subxt::sp_core::crypto::AccountId32>,
                        call: ::std::boxed::Box<runtime_types::darwinia_parachain_runtime::Call>,
                    },
                    #[codec(index = 1)]
                    as_multi {
                        threshold: ::core::primitive::u16,
        ...
        pub mod pallet_session {
            ...
            pub mod pallet {
                ...
                pub enum Call {
                    # [codec (index = 0)] set_keys { keys : runtime_types :: darwinia_parachain_runtime :: pallets :: session :: SessionKeys , proof : :: std :: vec :: Vec < :: core :: primitive :: u8 > , } , # [codec (index = 1)] purge_keys , }
                #[derive(
                    :: subxt :: codec :: Encode, :: subxt :: codec :: Decode, Debug, Clone,
                )]
                pub enum Error {
                ...
                pub enum Call {
                    ...
                    dispatch_as {
                        as_origin: ::std::boxed::Box<
                            runtime_types::darwinia_parachain_runtime::OriginCaller,
                        >,
                        call: ::std::boxed::Box<runtime_types::darwinia_parachain_runtime::Call>,
                    },
                    #[codec(index = 4)]
    ...
    impl ConstantsApi {
        ...
        pub fn bridge_darwinia_grandpa(&self) -> bridge_darwinia_grandpa::constants::ConstantsApi {
            bridge_darwinia_grandpa::constants::ConstantsApi
        }
        pub fn bridge_darwinia_messages(
            &self,
        ) -> bridge_darwinia_messages::constants::ConstantsApi {
            bridge_darwinia_messages::constants::ConstantsApi
        }
        pub fn darwinia_fee_market(&self) -> darwinia_fee_market::constants::ConstantsApi {
            darwinia_fee_market::constants::ConstantsApi
        }
        pub fn from_darwinia_issuing(&self) -> from_darwinia_issuing::constants::ConstantsApi {
            from_darwinia_issuing::constants::ConstantsApi
        }
    }
    pub struct StorageApi<'a, T: ::subxt::Config> {
        client: &'a ::subxt::Client<T>,
        ...
        T: ::subxt::Config,
    {
        ...
        pub fn bridge_darwinia_grandpa(
            &self,
        ) -> bridge_darwinia_grandpa::storage::StorageApi<'a, T> {
            bridge_darwinia_grandpa::storage::StorageApi::new(self.client)
        }
        pub fn bridge_darwinia_messages(
            &self,
        ) -> bridge_darwinia_messages::storage::StorageApi<'a, T> {
            bridge_darwinia_messages::storage::StorageApi::new(self.client)
        }
        pub fn darwinia_fee_market(&self) -> darwinia_fee_market::storage::StorageApi<'a, T> {
            darwinia_fee_market::storage::StorageApi::new(self.client)
        }
        pub fn from_darwinia_issuing(&self) -> from_darwinia_issuing::storage::StorageApi<'a, T> {
            from_darwinia_issuing::storage::StorageApi::new(self.client)
        }
        pub fn message_router(&self) -> message_router::storage::StorageApi<'a, T> {
            message_router::storage::StorageApi::new(self.client)
        }
    }
    pub struct TransactionApi<'a, T: ::subxt::Config, X, A> {
        client: &'a ::subxt::Client<T>,
        ...
        A: ::subxt::AccountData,
    {
        ...
        pub fn bridge_darwinia_grandpa(
            &self,
        ) -> bridge_darwinia_grandpa::calls::TransactionApi<'a, T, X, A> {
            bridge_darwinia_grandpa::calls::TransactionApi::new(self.client)
        }
        pub fn bridge_darwinia_messages(
            &self,
        ) -> bridge_darwinia_messages::calls::TransactionApi<'a, T, X, A> {
            bridge_darwinia_messages::calls::TransactionApi::new(self.client)
        }
        pub fn darwinia_fee_market(
            &self,
        ) -> darwinia_fee_market::calls::TransactionApi<'a, T, X, A> {
            darwinia_fee_market::calls::TransactionApi::new(self.client)
        }
        pub fn from_darwinia_issuing(
            &self,
        ) -> from_darwinia_issuing::calls::TransactionApi<'a, T, X, A> {
            from_darwinia_issuing::calls::TransactionApi::new(self.client)
        }
        pub fn message_router(&self) -> message_router::calls::TransactionApi<'a, T, X, A> {
            message_router::calls::TransactionApi::new(self.client)
        }
    }
}
