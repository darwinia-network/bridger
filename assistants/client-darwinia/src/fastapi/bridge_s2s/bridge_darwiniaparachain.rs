...
use crate::subxt_runtime::api::bridge_darwinia_parachain_messages::storage::{
...
impl S2SClientRelay for DarwiniaClient {
    ...
    async fn outbound_lanes(
        ...
        let outbound_lane_data = self
            .runtime()
            .storage()
            .bridge_darwinia_parachain_messages()
...
#[async_trait::async_trait]
impl S2SParaBridgeClientSolochain for DarwiniaClient {
