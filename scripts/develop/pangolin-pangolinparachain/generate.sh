...
SUBQL_S2S_PANGOLIN_PORT=${SUBQL_S2S_PANGOLIN_PORT:-13000}

SUBQL_S2S_PANGOLIN_PARACHAIN_DIR=$(_abs_path ${WORKSPACE}/subql/s2s/pangolin-parachain)
SUBQL_S2S_PANGOLIN_PARACHAIN_PORT=${SUBQL_S2S_PANGOLIN_PARACHAIN_PORT:-13001}

SUBQL_S2S_ROCOCO_DIR=$(_abs_path ${WORKSPACE}/subql/s2s/rococo)
SUBQL_S2S_ROCOCO_PORT=${SUBQL_S2S_ROCOCO_PORT:-13002}

SUBQL_PARACHAIN_ROCOCO_DIR=$(_abs_path ${WORKSPACE}/subql/parachain/rococo)
SUBQL_PARACHAIN_ROCOCO_PORT=${SUBQL_PARACHAIN_ROCOCO_PORT:-13003}
...
_gen_compose_content() {
  ...
  _SUBQL_S2S_PANGOLIN_PARACHAIN_DIR=$(echo ${SUBQL_S2S_PANGOLIN_PARACHAIN_DIR} | sed "${REGEX_SLASH}")
  _SUBQL_S2S_ROCOCO_DIR=$(echo ${SUBQL_S2S_ROCOCO_DIR} | sed "${REGEX_SLASH}")
  _SUBQL_PARACHAIN_ROCOCO_DIR=$(echo ${SUBQL_PARACHAIN_ROCOCO_DIR} | sed "${REGEX_SLASH}")
  ...
  CONTENT=$(echo "${CONTENT}" | sed "s/\${SUBQL_S2S_PANGOLIN_PARACHAIN_DIR}/${_SUBQL_S2S_PANGOLIN_PARACHAIN_DIR}/g")
  CONTENT=$(echo "${CONTENT}" | sed "s/\${SUBQL_S2S_PANGOLIN_PARACHAIN_PORT}/${SUBQL_S2S_PANGOLIN_PARACHAIN_PORT}/g")
  CONTENT=$(echo "${CONTENT}" | sed "s/\${SUBQL_S2S_ROCOCO_DIR}/${_SUBQL_S2S_ROCOCO_DIR}/g")
  CONTENT=$(echo "${CONTENT}" | sed "s/\${SUBQL_S2S_ROCOCO_PORT}/${SUBQL_S2S_ROCOCO_PORT}/g")
  CONTENT=$(echo "${CONTENT}" | sed "s/\${SUBQL_PARACHAIN_ROCOCO_DIR}/${_SUBQL_PARACHAIN_ROCOCO_DIR}/g")
  CONTENT=$(echo "${CONTENT}" | sed "s/\${SUBQL_PARACHAIN_ROCOCO_PORT}/${SUBQL_PARACHAIN_ROCOCO_PORT}/g")
