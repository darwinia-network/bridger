...
impl FeemarketApi for DarwiniaFeemarketApi {
    ...
    async fn update_relay_fee(
        ...
        crate::chains::darwinia::s2s_feemarket::update_relay_fee(
            &self.client,
            self.signer.clone(),
            amount,
        )
    ...
    async fn update_locked_collateral(
        ...
        crate::chains::darwinia::s2s_feemarket::update_locked_collateral(
            &self.client,
            self.signer.clone(),
            amount,
        )
