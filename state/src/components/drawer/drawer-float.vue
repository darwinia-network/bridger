<template>
  <div>
    ...
    <v-navigation-drawer class="box-bar" fixed permanent v-if="cond.enable_drawer && cond.show_drawer">
      <v-card>

        <!--      <v-card-title>
                <h1 class="text-h6">Bridger status</h1>
              </v-card-title>
              -->
        ...
        <v-app-bar flat dense>
          ...
          <v-tooltip bottom>
            <template v-slot:activator="{ on, attrs }">
              <v-btn icon v-bind="attrs" v-on="on" @click="cond.show_drawer = !cond.show_drawer">
    ...
    <v-tooltip bottom v-if="cond.enable_drawer && !cond.show_drawer">
      <template v-slot:activator="{ on, attrs }">
        <v-btn fab class="btn-mininav" v-bind="attrs" v-on="on" @click="cond.show_drawer = !cond.show_drawer">
