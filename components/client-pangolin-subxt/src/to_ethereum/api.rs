...
use crate::frame::{
    bridge::relay_authorities::{
        AuthoritiesStoreExt, AuthoritiesToSignStoreExt, MmrRootsToSignStoreExt, NextTermStoreExt,
...
use crate::rpc::HeaderMMR;
use crate::types::{EcdsaAddress, EcdsaMessage};
...
impl Darwinia2Ethereum {
    ...
    pub async fn ecdsa_sign_and_submit_signed_authorities(
        ...
        match &account.0.real {
            // proxy
            Some(real) => {
                log::trace!("Proxyed ecdsa sign and submit authorities to darwinia");
            ...
            None => {
                log::trace!("Ecdsa sign and submit authorities to darwinia");
                let tx_hash = self
                    .darwinia
                    .subxt
