...
impl<
        ...
        CPI: S2SSoloBridgeSoloChainInfo,
        SI: SubqueryInfo,
    > BridgeService for RelaychainToSolochainHeaderRelayService<CSI, CRI, CPI, SI>
{
}
...
impl<
        ...
        CPI: S2SSoloBridgeSoloChainInfo,
        SI: SubqueryInfo,
    > Service for RelaychainToSolochainHeaderRelayService<CSI, CRI, CPI, SI>
{
    type Bus = BridgeBus;
...
impl<
        ...
        CPI: S2SSoloBridgeSoloChainInfo,
        SI: SubqueryInfo,
    > RelaychainToSolochainHeaderRelayService<CSI, CRI, CPI, SI>
{
