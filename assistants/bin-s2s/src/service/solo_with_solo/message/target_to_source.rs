...
#[derive(Debug)]
pub struct TargetToSourceMessageRelayService<CI: S2SSoloChainInfo, SI: SubqueryInfo> {
...
impl<CI: S2SSoloChainInfo, SI: SubqueryInfo> Service for TargetToSourceMessageRelayService<CI, SI> {
    type Bus = BridgeBus;
...
impl<CI: S2SSoloChainInfo, SI: SubqueryInfo> TargetToSourceMessageRelayService<CI, SI> {
