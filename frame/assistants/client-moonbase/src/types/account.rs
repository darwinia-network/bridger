...
/// AccountId
pub type AccountId = <MoonbaseSubxtConfig as subxt::Config>::AccountId;
/// Signer
pub type Signer = PairSigner<MoonbaseSubxtConfig, NodeRuntimeSignedExtra, Pair>;

/// Account
#[derive(Clone)]
pub struct MoonbaseAccount {
    /// Account Id
...
impl Debug for MoonbaseAccount {
