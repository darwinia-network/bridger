...
/// AccountId
pub type AccountId = <DarwiniaParachainSubxtConfig as subxt::Config>::AccountId;
/// Signer
pub type Signer = PairSigner<DarwiniaParachainSubxtConfig, NodeRuntimeSignedExtra, Pair>;
