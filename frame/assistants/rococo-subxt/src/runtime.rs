...
pub mod api {
                ...
                X: ::subxt::extrinsic::ExtrinsicParams<T>,
            {
                ...
                pub fn enter(
                    ...
                    data: runtime_types::polkadot_primitives::v1::InherentData<
                        ...
                        >,
                    >,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, Enter, DispatchError, root_mod::Event>
                {
                    let call = Enter { data };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
    ...
    pub mod paras {
        ...
        pub mod storage {
            ...
            pub struct Heads<'a>(pub &'a runtime_types::polkadot_parachain::primitives::Id);
            ...
            pub struct PastCodeMeta<'a>(pub &'a runtime_types::polkadot_parachain::primitives::Id);
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                pub async fn heads_iter(
                    &self,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<::subxt::KeyIter<'a, T, Heads<'a>>, ::subxt::BasicError>
                {
                    self.client.storage().iter(hash).await
                }
    ...
    pub mod registrar {
        ...
        pub mod calls {
                ...
                X: ::subxt::extrinsic::ExtrinsicParams<T>,
            {
                ...
                pub fn reserve(
                    &self,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, Reserve, DispatchError, root_mod::Event>
                {
                    let call = Reserve {};
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
        ...
        pub mod storage {
            ...
            pub struct Paras<'a>(pub &'a runtime_types::polkadot_parachain::primitives::Id);
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                pub async fn paras_iter(
                    &self,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<::subxt::KeyIter<'a, T, Paras<'a>>, ::subxt::BasicError>
                {
                    self.client.storage().iter(hash).await
                }
        ...
        pub mod storage {
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                pub async fn winning_iter(
                    &self,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<::subxt::KeyIter<'a, T, Winning<'a>>, ::subxt::BasicError>
                {
                    self.client.storage().iter(hash).await
                }
            }
    ...
    pub mod crowdloan {
        ...
        pub mod calls {
                ...
                X: ::subxt::extrinsic::ExtrinsicParams<T>,
            {
                ...
                pub fn withdraw(
                    ...
                    who: ::subxt::sp_core::crypto::AccountId32,
                    index: runtime_types::polkadot_parachain::primitives::Id,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, Withdraw, DispatchError, root_mod::Event>
                {
                ...
                pub fn dissolve(
                    &self,
                    index: runtime_types::polkadot_parachain::primitives::Id,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, Dissolve, DispatchError, root_mod::Event>
                {
                ...
                pub fn edit(
                    ...
                    verifier: ::core::option::Option<runtime_types::sp_runtime::MultiSigner>,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, Edit, DispatchError, root_mod::Event>
                {
                    let call = Edit {
                        index,
                        cap,
                ...
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, AddMemo, DispatchError, root_mod::Event>
                {
                ...
                pub fn poke(
                    &self,
                    index: runtime_types::polkadot_parachain::primitives::Id,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, X, Poke, DispatchError, root_mod::Event>
                {
                    let call = Poke { index };
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
        ...
        pub mod storage {
            use super::runtime_types;
            pub struct Funds<'a>(pub &'a runtime_types::polkadot_parachain::primitives::Id);
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                pub async fn funds_iter(
                    &self,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<::subxt::KeyIter<'a, T, Funds<'a>>, ::subxt::BasicError>
                {
                    self.client.storage().iter(hash).await
                }
    ...
    pub mod slots {
        ...
        pub mod storage {
            use super::runtime_types;
            pub struct Leases<'a>(pub &'a runtime_types::polkadot_parachain::primitives::Id);
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                pub async fn leases_iter(
                    &self,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<::subxt::KeyIter<'a, T, Leases<'a>>, ::subxt::BasicError>
                {
                    self.client.storage().iter(hash).await
                }
            }
        ...
        pub mod storage {
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                pub async fn queries_iter(
                    &self,
                    hash: ::core::option::Option<T::Hash>,
                ) -> ::core::result::Result<::subxt::KeyIter<'a, T, Queries<'a>>, ::subxt::BasicError>
                {
                    self.client.storage().iter(hash).await
                }
        ...
        X: ::subxt::extrinsic::ExtrinsicParams<T>,
    {
        ...
        pub fn paras_sudo_wrapper(&self) -> paras_sudo_wrapper::calls::TransactionApi<'a, T, X> {
        ...
        pub fn validator_manager(&self) -> validator_manager::calls::TransactionApi<'a, T, X> {
